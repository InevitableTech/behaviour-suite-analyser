...
class NoSelectorsInSteps extends BaseRule {
    const VIOLATION_MESSAGE = 'Found css/xpath selector "%s" which impact re-usability of steps and make maintenance hard. Consider abstracting these in the library.';
